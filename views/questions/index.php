<div class="container-fluid">
	<div class="row flex-xl-nowrap mt-2">
        <div class="col-12 col-md-3 col-xl-2">
            <form method="post" action="<?=BASE_URL?>/questions/ajouter">
		...
		if (isset($typeErreur) && !empty($typeErreur)) {
		    ...
		    $listeErreur = explode ( "_" , $typeErreur);
		    $msg = "";
		...
		foreach($lesQuestions as $question){
		    echo "<li class=\"list-group-item\"><a href=\"editQuesion.php?id=".$question['id']."\">".$question['texte']." (auteur:".$question['nom'].")</li>";
		}
		echo "</ul>";
